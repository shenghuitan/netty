...
public final class Http2Client {
    ...
    static {
        Http2Consts.initSystemProperties();
    }
    ...
    static final String URL2DATA = System.getProperty("url2data");
                ...
                public void run() {
                    while (true) {
                        ...
                        logger.info("Finished HTTP/2 request(s), streams:{}, totalCost:{}, averageCost:{}, counter:{}, successTimer:{}",
                                streams, counter.length, counter.length.get() / counter.succeed.get(), counter, successTimer);
    ...
    public class PromiseListener implements GenericFutureListener<Future<? super Void>> {
        ...
        public void operationComplete(Future<? super Void> future) throws Exception {
            ...
            counter.length.getAndAdd(t0.cost());
            queue.offer(1L);
        }
    }
    ...
    public void send(HttpScheme scheme, AsciiString hostName, HttpResponseHandler responseHandler,
        ...
        if (URL2 != null) {
            ...
            FullHttpRequest request = new DefaultFullHttpRequest(HTTP_1_1, POST, getUrl2(),
    ...
    private String getUrl2() {
        return URL2 + "?=" + System.currentTimeMillis();
    }
